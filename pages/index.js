...
export default function Home({ links, hasMore }) {
  ...
  return (
    <div>
      ...
      <header className="container  mx-auto mt-32 p-4">
        <h1 className="drop-shadow text-center  text-6xl md:text-8xl font-black font-lobster text-green-700">NomadLinks</h1>

      </header>

      <main >

        <div className="container w-5/6 md:w-full mb-16 mx-auto mt-20 p-4 rounded-3xl border-2 border-green-100	 bg-white shadow-2xl">

          <div className="ml-2 md:ml-6 mt-8 flex flex-wrap">
            ...
            {links.map((linkItem) => (<div className="mx-4 lg:mx-6 mb-16" key={linkItem.id}>
              ...
              <h2 className="text-center md:text-left font-roboto my-8 text-2xl text-green-800 font-black">{linkItem.name}</h2>
